        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasePrice = table.Column<decimal>(type: "numeric(15,2)", precision: 15, scale: 2, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomPrice = table.Column<decimal>(type: "numeric(15,2)", precision: 15, scale: 2, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerPricings", x => new { x.CustomerId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DebtPayments_Users_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Locations_Users_AssignedTo",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DebtAmount = table.Column<decimal>(type: "numeric(15,2)", precision: 15, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContainerLoans_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContainerLoans_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContainerLoans_Transactions_TransactionId",
                        column: x => x.TransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ContainerLoans_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    KurirId = table.Column<Guid>(type: "uuid", nullable: false),
                    CustomerId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    Status = table.Column<string>(type: "text", nullable: false),
                    TransactionId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryAssignments_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeliveryAssignments_Transactions_TransactionId",
                        column: x => x.TransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_DeliveryAssignments_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeliveryAssignments_Users_KurirId",
                        column: x => x.KurirId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseCost = table.Column<decimal>(type: "numeric(15,2)", precision: 15, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryAssignmentItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeliveryAssignmentItems_DeliveryAssignments_AssignmentId",
                        column: x => x.AssignmentId,
                        principalTable: "DeliveryAssignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeliveryAssignmentItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContainerLoans_CreatedBy",
                table: "ContainerLoans",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ContainerLoans_CustomerId",
                table: "ContainerLoans",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ContainerLoans_ProductId",
                table: "ContainerLoans",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ContainerLoans_TransactionId",
                table: "ContainerLoans",
                column: "TransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerPricings_ProductId",
                table: "CustomerPricings",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_DebtPayments_CreatedBy",
                table: "DebtPayments",
                column: "CreatedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAssignmentItems_AssignmentId",
                table: "DeliveryAssignmentItems",
                column: "AssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAssignmentItems_ProductId",
                table: "DeliveryAssignmentItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAssignments_CreatedBy",
                table: "DeliveryAssignments",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAssignments_CustomerId",
                table: "DeliveryAssignments",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAssignments_KurirId",
                table: "DeliveryAssignments",
                column: "KurirId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAssignments_TransactionId",
                table: "DeliveryAssignments",
                column: "TransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_Locations_AssignedTo",
                table: "Locations",
                column: "AssignedTo");
